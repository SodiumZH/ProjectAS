...
All resources (figures, texts, *etc.*) related to original L2 game belong to *NCSoft*. Temporarily L2 resources (from Internet) have to be used in development for testing, but I will not commercially publish any releases using L2 resource without license of *NCSoft*.
...
e-mail: sodiumzh@outlook.com

website: www.sodium-studio.com (Not available yet)
