...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Natrium|MobSystem|Mob|Constants")
	...
	UFUNCTION(BlueprintPure, meta = (BlueprintAutocast, DefaultToSelf, DisplayName = "Get Time Control (Mob)", Keywords = "timeline time line time controller"), Category = "Natrium|MobSystem|Mob|Components")
	static void GetTimeControl_BP(ANaMob* Target, UTimeControlComponent*& TimeControl);

	// Get skill manager component of a mob
	UFUNCTION(BlueprintPure, meta = (BlueprintAutocast, DefaultToSelf, DisplayName = "Get Skill Manager (Mob)", Keywords = "skill action controller"), Category = "Natrium|MobSystem|Mob|Components")
	static void GetSkillManager_BP(ANaMob* Target, UNaMobSkillManager*& SkillManager);

	UFUNCTION(BlueprintPure, meta = (BlueprintAutocast, DefaultToSelf, DisplayName = "Get Weapon Manager (Mob)", Keywords = "equipment arms controller"), Category = "Natrium|MobSystem|Mob|Components")
	static void GetWeaponManager_BP(ANaMob* Target, UNaMobWeaponManager*& WeaponManager);

	UFUNCTION(BlueprintPure, meta = (BlueprintAutocast, DefaultToSelf, DisplayName = "Get Basic State Manager (Mob)", Keywords = "status movement die death alive invincible controller"), Category = "Natrium|MobSystem|Mob|Components")
	...
	UFUNCTION(BlueprintPure, meta = (BlueprintAutocast, DefaultToSelf, DisplayName = "Get All Related Actors (Mob)", Keywords = "relative accessory accessories attached bound bind"), Category = "Natrium|MobSystem|Mob|Components")
	...
	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Is Player Mob"), Category = "Natrium|MobSystem|Mob|Type")
	static bool IsPlayerMob_BP(ANaMob* Target);

	/* Return the mob's player component. If there isn't one, return null. */
	UFUNCTION(BlueprintPure, meta = (BlueprintAutoCast, DefaultToSelf, DisplayName = "Get Mob Player Component"), Category = "Natrium|MobSystem|Mob|Type")
	...
	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Is Enemy Mob"), Category = "Natrium|MobSystem|Mob|Type")
	static bool IsEnemyMob_BP(ANaMob* Target);

	/* Return the mob's enemy component. If there isn't one, return null. */
	UFUNCTION(BlueprintPure, meta = (BlueprintAutoCast, DefaultToSelf, DisplayName = "Get Mob Enemy Component"), Category = "Natrium|MobSystem|Mob|Type")
	static UNaMobEnemyComponent* GetEnemyComponent_BP(ANaMob* Target);

	/*** Skill & weapon possessions ***/

	UFUNCTION(BlueprintPure, meta = (BlueprintAutoCast, DefaultToSelf, DisplayName = "Get All Skill Names"), Category = "Natrium|MobSystem|Skill")
	static void GetAllSkillNames_BP(ANaMob* Target, TArray<FName>& SkillNames);

	UFUNCTION(BlueprintPure, meta = (BlueprintAutoCast, DefaultToSelf, DisplayName = "Get All Skills"), Category = "Natrium|MobSystem|Skill")
	static void GetAllSkills_BP(ANaMob* Target, TArray<ANaMobSkill*>& Skills);

	UFUNCTION(BlueprintPure, meta = (BlueprintAutoCast, DefaultToSelf, DisplayName = "Get All Weapon Names"), Category = "Natrium|MobSystem|Weapon")
	static void GetAllWeaponNames_BP(ANaMob* Target, TArray<FName>& WeaponNames);

	UFUNCTION(BlueprintPure, meta = (BlueprintAutoCast, DefaultToSelf, DisplayName = "Get All Weapons"), Category = "Natrium|MobSystem|Weapon")
	...
	*/
	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, BlueprintThreadSafe, DisplayName = "Get Animation State Switch Value", Keywords = "animation switch anim switch anim state animation state"), Category = "Natrium|MobSystem|AnimationSwitch")
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (DefaultToSelf, DisplayName = "Open Animation State Switch", Keywords = "animation switch anim switch anim state animation state"), Category = "Natrium|MobSystem|AnimationSwitch")
	static void OpenAnimStateSwitch_BP(ANaMob* Target, FName Key, float DeltaTime = 0.1);

	/** Turn off an animation switch.
	* Animation switch is a boolean specified by name for animation blueprint. In animation blueprint you can call switch value for state change.
	*/
	UFUNCTION(BlueprintCallable, meta = (DefaultToSelf, DisplayName = "Close Animation State Switch", Keywords = "animation switch anim switch anim state animation state"), Category = "Natrium|MobSystem|AnimationSwitch")
	...
	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Get Weapon Register Name", Keywords = "weapon name get name"), Category = "Natrium|MobSystem|Mob|Weapon")
	...
	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Get Weapon from Register Name", Keywords = "weapon name get weapon from name"), Category = "Natrium|MobSystem|Mob|Weapon")
	...
	UFUNCTION(BlueprintPure, meta = (BlueprintAutocast, DefaultToSelf, DisplayName = "Get Time Control (Mob Skill)"), Category = "Natrium|MobSystem|Skill")
	...
	*/
	UFUNCTION(BlueprintPure, meta = (BlueprintAutocast, DefaultToSelf, DisplayName = "Get Source Mob (Mob Skill)"), Category = "Natrium|MobSystem|Skill")
	static void GetSource_BP_Skill(ANaMobSkill* InSkill, ANaMob*& Source);

	/* Get socket name of skill.
	* Warning: this result is invalid on begin play. If it's needed to call it on begin play, delay a short time (e.g. 0.01s) first.
	*/
	UFUNCTION(BlueprintPure, meta = (BlueprintAutocast, DefaultToSelf, DisplayName = "Get Socket Name (Mob Skill)"), Category = "Natrium|MobSystem|Skill")
	static void GetSocket_BP_Skill(ANaMobSkill* InSkill, FName& Socket);

	/* Get register name of skill.
	* Warning: this result is invalid on begin play. If it's needed to call it on begin play, delay a short time (e.g. 0.01s) first.
	*/
	UFUNCTION(BlueprintPure, meta = (BlueprintAutocast, DefaultToSelf, DisplayName = "Get Register Name (Mob Skill)"), Category = "Natrium|MobSystem|Skill")
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (DefaultToSelf, DisplayName = "Use Skill by Class"), Category = "Natrium|MobSystem|Skill")
	...
	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Get Skill By Register Name", Keywords = "register name reg name"), Category = "Natrium|MobSystem|Skill")
	...
	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Get Skill Registeration", Keywords = "source register name reg name"), Category = "Natrium|MobSystem|Skill")
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (DefaultToSelf, DisplayName = "Get Collision Set (Mob Skill)"), Category = "Natrium|MobSystem|Skill")
	...
	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Get Source Skill (Skill Collision)"), Category = "Natrium|MobSystem|SkillCollision")
	static void GetSourceSkill_BP(ANaMobSkillCollision* Target, ANaMobSkill*& SourceSkill);

	/* Get socket name of skill collision */
	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Get Socket Name (Skill Collision)"), Category = "Natrium|MobSystem|SkillCollision")
	static void GetSocketName_BP(ANaMobSkillCollision* Target, FName& SocketName);

	/* Get hit detector of skill collision */
	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Get Hit Detector (Skill Collision)", Keywords = "get detector"), Category = "Natrium|MobSystem|SkillCollision")
	...
	* @Param DoAttachment If set false, the skill actor will not attach to anything and generate with world transform.
	*/
	UFUNCTION(BlueprintCallable, meta = (DefaultToSelf, DisplayName = "Make Skill Collision by Class"), Category = "Natrium|MobSystem|SkillCollision")
	...
	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Get Owner Mob (Weapon)"), Category = "Natrium|MobSystem|Weapon")
	static void GetOwnerMob_BP_Weapon(ANaMobWeapon* InWeapon, ANaMob*& OwnerMob);

	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Has Owner (Weapon)", Keywords = "is owned"), Category = "Natrium|MobSystem|Weapon")
	static void HasOwner_BP_Weapon(ANaMobWeapon* InWeapon, bool& HasOwner);

	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Get Register Name (Weapon)", Keywords = "reg name regname"), Category = "Natrium|MobSystem|Weapon")
	static void GetRegName_BP_Weapon(ANaMobWeapon* InWeapon, FName& RegName);

	UFUNCTION(BlueprintPure, meta = (DefaultToSelf, DisplayName = "Get Socket Name (Weapon)", Keywords = "reg name regname"), Category = "Natrium|MobSystem|Weapon")
