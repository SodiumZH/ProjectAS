...
public:
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Identity (ObjectRotator)", CompactNodeTitle = "0", Keywords = "0 identity"), Category = "Utilities|ObjectRotator")
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "ToObjectRotator (VectorRoll)", CompactNodeTitle = "->", Keywords = "to object rotation vector roll"), Category = "Utilities|ObjectRotator")
	...
	*/
	...
	static FObjectRotator InverseObjRot(FObjectRotator First, FObjectRotator Next) { return First - Next; };
