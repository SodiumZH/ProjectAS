...
public:
	...
	*/
	UFUNCTION(BlueprintNativeEvent, meta = (DisplayName = "Initialized (Skill Collision)"), Category = "NaPack|MobSystem|SkillCollision")
	void Initialized();
...
public:
	...
	*/
	...
	UFUNCTION(BlueprintNativeEvent, Category = "NaPack|MobSystem|SkillCollision")
